def get_tf_functions():
    ...
    return [
        ...
        "tf.contrib.bayesflow.stochastic_variables()",
        ...
        "tf.contrib.keras.api()",
        "tf.contrib.keras.applications()",
        "tf.contrib.keras.applications.inception_v3()",
        ...
        "tf.contrib.keras.callbacks.History()",
        ...
        "tf.contrib.keras.initializers.Ones()",
        ...
        "tf.contrib.keras.initializers.Zeros()",
        "tf.contrib.keras.layers()",
        "tf.contrib.keras.layers.Activation()",
        "tf.contrib.keras.layers.ActivityRegularization()",
        "tf.contrib.keras.layers.Add()",
        "tf.contrib.keras.layers.add()",
        "tf.contrib.keras.layers.Average()",
        "tf.contrib.keras.layers.average()",
        "tf.contrib.keras.layers.AveragePooling1D()",
        "tf.contrib.keras.layers.AveragePooling2D()",
        "tf.contrib.keras.layers.AveragePooling3D()",
        "tf.contrib.keras.layers.AvgPool1D()",
        "tf.contrib.keras.layers.AvgPool2D()",
        "tf.contrib.keras.layers.AvgPool3D()",
        "tf.contrib.keras.layers.BatchNormalization()",
        "tf.contrib.keras.layers.Concatenate()",
        "tf.contrib.keras.layers.concatenate()",
        "tf.contrib.keras.layers.Conv1D()",
        "tf.contrib.keras.layers.Conv2D()",
        "tf.contrib.keras.layers.Conv2DTranspose()",
        "tf.contrib.keras.layers.Conv3D()",
        "tf.contrib.keras.layers.ConvLSTM2D()",
        "tf.contrib.keras.layers.Convolution1D()",
        "tf.contrib.keras.layers.Convolution2D()",
        "tf.contrib.keras.layers.Convolution2DTranspose()",
        "tf.contrib.keras.layers.Convolution3D()",
        "tf.contrib.keras.layers.Cropping1D()",
        "tf.contrib.keras.layers.Cropping2D()",
        "tf.contrib.keras.layers.Cropping3D()",
        "tf.contrib.keras.layers.Dense()",
        "tf.contrib.keras.layers.Dot()",
        "tf.contrib.keras.layers.dot()",
        "tf.contrib.keras.layers.Dropout()",
        "tf.contrib.keras.layers.ELU()",
        "tf.contrib.keras.layers.Embedding()",
        "tf.contrib.keras.layers.Flatten()",
        "tf.contrib.keras.layers.GaussianDropout()",
        "tf.contrib.keras.layers.GaussianNoise()",
        "tf.contrib.keras.layers.GlobalAveragePooling1D()",
        "tf.contrib.keras.layers.GlobalAveragePooling2D()",
        "tf.contrib.keras.layers.GlobalAveragePooling3D()",
        "tf.contrib.keras.layers.GlobalAvgPool1D()",
        "tf.contrib.keras.layers.GlobalAvgPool2D()",
        "tf.contrib.keras.layers.GlobalAvgPool3D()",
        "tf.contrib.keras.layers.GlobalMaxPool1D()",
        "tf.contrib.keras.layers.GlobalMaxPool2D()",
        "tf.contrib.keras.layers.GlobalMaxPool3D()",
        "tf.contrib.keras.layers.GlobalMaxPooling1D()",
        "tf.contrib.keras.layers.GlobalMaxPooling2D()",
        "tf.contrib.keras.layers.GlobalMaxPooling3D()",
        "tf.contrib.keras.layers.GRU()",
        "tf.contrib.keras.layers.Input()",
        "tf.contrib.keras.layers.InputLayer()",
        "tf.contrib.keras.layers.InputSpec()",
        "tf.contrib.keras.layers.Lambda()",
        "tf.contrib.keras.layers.Layer()",
        "tf.contrib.keras.layers.LeakyReLU()",
        "tf.contrib.keras.layers.LocallyConnected1D()",
        "tf.contrib.keras.layers.LocallyConnected2D()",
        "tf.contrib.keras.layers.LSTM()",
        "tf.contrib.keras.layers.Masking()",
        "tf.contrib.keras.layers.Maximum()",
        "tf.contrib.keras.layers.maximum()",
        "tf.contrib.keras.layers.MaxPool1D()",
        "tf.contrib.keras.layers.MaxPool2D()",
        "tf.contrib.keras.layers.MaxPool3D()",
        "tf.contrib.keras.layers.MaxPooling1D()",
        "tf.contrib.keras.layers.MaxPooling2D()",
        "tf.contrib.keras.layers.MaxPooling3D()",
        "tf.contrib.keras.layers.Multiply()",
        "tf.contrib.keras.layers.multiply()",
        "tf.contrib.keras.layers.Permute()",
        "tf.contrib.keras.layers.PReLU()",
        "tf.contrib.keras.layers.RepeatVector()",
        "tf.contrib.keras.layers.Reshape()",
        "tf.contrib.keras.layers.SeparableConv2D()",
        "tf.contrib.keras.layers.SeparableConvolution2D()",
        "tf.contrib.keras.layers.SimpleRNN()",
        "tf.contrib.keras.layers.SpatialDropout1D()",
        "tf.contrib.keras.layers.SpatialDropout2D()",
        "tf.contrib.keras.layers.SpatialDropout3D()",
        "tf.contrib.keras.layers.ThresholdedReLU()",
        "tf.contrib.keras.layers.UpSampling1D()",
        "tf.contrib.keras.layers.UpSampling2D()",
        "tf.contrib.keras.layers.UpSampling3D()",
        "tf.contrib.keras.layers.ZeroPadding1D()",
        "tf.contrib.keras.layers.ZeroPadding2D()",
        "tf.contrib.keras.layers.ZeroPadding3D()",
        "tf.contrib.keras.losses()",
        ...
        "tf.contrib.keras.preprocessing.sequence()",
        ...
        "tf.contrib.keras.preprocessing.text()",
        ...
        "tf.contrib.keras.wrappers()",
        "tf.contrib.keras.wrappers.scikit_learn()",
